  ...
  return (
    <Layout>
      <StaticImage 
        ...
        width={1920}
      />
      <div className="text-[#f5f1be] font-Palatino text-center text-xs md:text-lg lg:text-2xl mx-5 md:mx-12">
      ...
      <div className="text-[10px] md:text-2xl xl:text-3xl text-white text-center md:mt-3 lg:mt-0">
        View More
