    ...
    <Layout className="overflow-x-hidden">
      <div          
        ...
        <StaticImage 
          ...
          width={3840}
        />
        <div className="text-[#f5f1be] font-OpenSans text-center text-md overflow-hidden md:text-xl lg:text-2xl xl:text-3xl mx-8 sm:mx-16 md:mx-20 lg:mx-24 xl:mx-28 mb-28 md:mb-32 lg:mb-36 xl:mb-40 mt-4">
