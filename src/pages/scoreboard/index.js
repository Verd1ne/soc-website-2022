...
// 		return selectedTag === selectedCompe
// 			? setSelectedCompe("")
// 			: setSelectedCompe(selectedTag);
// 	};
...
// 	return (
// 		<Layout>
// 			<div className="font-Broadway text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white mt-32 md:mt-36 lg:mt-40 xl:mt-44 mb-10 md:mb-16 lg:mb-24 xl:mb-32 overflow-hidden text-center">
// 				BROWSE COMPETITIONS
// 			</div>
// 			<SplideCompe selectedCompe={selectedCompe} handleTag={handleTag} />
// 			<div className="font-Broadway text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl text-[#f5f1be] my-10 mx-5 md:mx-10 overflow-hidden text-center">
// 				SCOREBOARD {selectedCompe}
// 			</div>
// 			{!selectedCompe ? (
// 				<div className="text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl text-[#f5f1be] my-10 mx-5 md:mx-10 overflow-hidden text-center font-ProductSans">
// 					(Anda belum memilih lomba)
// 				</div>
// 			) : (
...
// 									<div className="text-gold bg-red-900 rounded-xl">
// 										1st Place
// 									</div>
// 									<div className="bg-[#040030] mt-5 rounded-xl border-2 border-gold h-[200px] w-fit align-center mx-auto px-3 py-2">
// 										<p className="text-sm lg:text-3xl text-gold">
// 											{compe.first}
// 										</p>
// 										<hr />
// 										<p className="mt-2 text-[12px] md:text-xl">
// 											{compe.first1}
// 										</p>
// 										<p className="mt-1 text-[12px] md:text-xl">
// 											{compe.first2}
// 										</p>
// 									</div>
// 								</div>
// 								<div className="my-3">
// 									<div className="text-[#C0C0C0] bg-red-900 rounded-xl">
// 										2nd Place
// 									</div>
// 									<div className="bg-[#040030] mt-5 rounded-xl border-2 border-[#C0C0C0] h-[200px] w-fit align-center mx-auto px-3 py-2">
// 										<p className="text-sm md:text-3xl text-[#C0C0C0]">
// 											{compe.second}
// 										</p>
// 										<hr />
// 										<p className="mt-2 text-[12px] md:text-xl">
...
// 							</div>
// 						))}
// 					<div className="text-white text-3xl lg:text-5xl mt-24 mb-8 text-left">
// 						DAY 1 (26 Oct)
// 						<hr className="mt-3" />
// 					</div>
// 					{filteredCompes &&
