...
"Paskibra", "Pencak Silat", "Podcast", "Speech", "Vlog"];
  return (
    <Layout>
    <div className='font-Broadway text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white overflow-hidden mt-32 mb-10 text-center'>COMPETITIONS</div>
