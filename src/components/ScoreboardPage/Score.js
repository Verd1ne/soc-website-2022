                    ...
                    <div className='fixed inset-0 overflow-y-auto'>
                        ...
                        <Transition.Child
                            ...
                            <Dialog.Panel className="lg:w-full w-fit max-w-lg  overflow-hidden rounded-2xl bg-gray-900 border-2 border-yellow-400 border-md md:p-6 p-1 text-center align-middle shadow-xl transition-all">
                                ...
                                <Dialog.Title
                                    as="h3"
                                    className="md:text-2xl text-sm grid justify-self-center font-black leading-6 text-white px-3"
                                >
                                    Match Details
                                </Dialog.Title>
                                <div className="flex justify-center mt-2 ">
                                    ...
                                    { set1 ? (
                                        <div className='grid grid-cols-3 md:gap-x-5'>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set1[0]) > parseInt(set1[1]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set1[0] }</div>   
                                            </div>
                                            <div className="lg:text-xl text-[7px] text-white font-bold rounded-3xl grid place-items-center ">
                                                <div>- 1 -</div>
                                            </div>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set1[1]) > parseInt(set1[0]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set1[1] }</div>
                                            </div>   
                                        </div>
                                        ) : ''}
                                        { set2 ? (
                                        <div className='grid grid-cols-3 md:gap-x-5'>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set2[0]) > parseInt(set2[1]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set2[0] }</div>   
                                            </div>
                                            <div className="lg:text-xl text-[7px] text-white font-bold rounded-3xl grid place-items-center ">
                                                <div>- 2 -</div>
                                            </div>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set2[1]) > parseInt(set2[0]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set2[1] }</div>
                                            </div>   
                                        </div>
                                        ) : ''}
                                        { set3 ? (
                                        <div className='grid grid-cols-3 md:gap-x-5'>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set3[0]) > parseInt(set3[1]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set3[0] }</div>   
                                            </div>
                                            <div className="lg:text-xl text-[7px] text-white font-bold rounded-3xl grid place-items-center ">
                                                <div>- 3 -</div>
                                            </div>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set3[1]) > parseInt(set3[0]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set3[1] }</div>
                                            </div>   
                                        </div>
                                        ) : ''}
                                        { set4 ? (
                                        <div className='grid grid-cols-3 md:gap-x-5'>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set4[0]) > parseInt(set4[1]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set4[0] }</div>   
                                            </div>
                                            <div className="lg:text-xl text-[7px] text-white font-bold rounded-3xl grid place-items-center ">
                                                <div>- 4 -</div>
                                            </div>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set4[1]) > parseInt(set4[0]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set4[1] }</div>
                                            </div>   
                                        </div>
                                        ) : ''}
                                        { set5 ? (
                                        <div className='grid grid-cols-3 md:gap-x-5'>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set5[0]) > parseInt(set5[1]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set5[0] }</div>   
                                            </div>
                                            <div className="lg:text-xl text-[7px] text-white font-bold rounded-3xl grid place-items-center ">
                                                <div>- 5 -</div>
                                            </div>
                                            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                                                <div className={`${parseInt(set5[1]) > parseInt(set5[0]) ? 'bg-red-700 text-white' : 'text-red-700'} text-lg sm:text-2xl lg:text-5xl xl:text-5xl   rounded-lg p-1 grid place-items-center py-auto w-fit align-middle`}>{ set5[1] }</div>
                                            </div>   
                                        </div>
                                        ) : ''}
