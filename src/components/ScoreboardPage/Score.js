    ...
    return(
        <div className='grid grid-cols-3 gap-x-5 my-12 bg-red-900 border-2 border-gold rounded-3xl p-5 text-center align-center px-auto'>
            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                <div className="bg-gray-900 text-[10px] xl:text-3xl md:text-lg xl:rounded-2xl rounded-lg xl:p-3 p-2 grid place-items-center py-auto xl:h-[95px] h-[70px] w-fit">{props.team1}</div>
            ...
            <div className="font-bold rounded-3xl lg:p-10 justify-center mx-auto">
                <div className="bg-gray-900 text-[10px] xl:text-3xl md:text-lg xl:rounded-2xl rounded-lg xl:p-3 p-2 grid place-items-center py-auto xl:h-[95px] h-[70px] w-fit">{props.team2}</div>
