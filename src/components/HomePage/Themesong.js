...
export default function Themesong() {
  return (
    <div className="relative z-10 bg-[url('../images/Disc.png')] bg-no-repeat bg-top bg-contain px-12 h-[300px] md:h-[600px] lg:h-[700px]">
      ...
      <div className="flex flex-row text-center gap-4 md:gap-16 place-content-center overflow-hidden">
        <a href="https://www.instagram.com/smukiee/" target="blank" className='text-red-600 font-extrabold text-sm md:text-3xl lg:text-4xl bg-white pt-0.5 sm:py-2 px-2 sm:px-4 hover:scale-110 duration-300 ease-in-out'>
