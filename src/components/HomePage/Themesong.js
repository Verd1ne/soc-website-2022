  ...
  return (
    <div  
      ...
      <div className="flex flex-row text-center gap-4 md:gap-16 place-content-center overflow-hidden py-3">
        <a href="https://open.spotify.com/artist/6dBkUvQfVsXZiz9X9DDnTo?si=dI6zyRaSTkaLpFfu2Qt1-A" target="blank" className='text-red-600 font-extrabold text-xl sm:text-2xl md:text-3xl lg:text-4xl bg-white pt-0.5 sm:py-2 px-2 sm:px-4 hover:scale-110 duration-300 ease-in-out'>
        ...
        <a href="https://www.youtube.com/user/SMAK1cup" target="blank" className='text-red-600 font-extrabold  text-xl sm:text-2xl md:text-3xl lg:text-4xl bg-white pt-0.5 sm:py-2 px-2 sm:px-4 hover:scale-110 duration-300 ease-in-out'>
